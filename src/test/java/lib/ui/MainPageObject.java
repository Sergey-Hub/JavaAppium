...
public class MainPageObject {
    ...
    public void tryClickElementWithFewAttempts (String locator, String error_mesage, int amount_of_attempts) {
        int current_attempts = 0;
        boolean need_more_attempts = true;

        while (need_more_attempts) {
            try {
                this.waitForElementAndClick(locator, error_mesage,1);
    ...
    public boolean ifTitlesHaveSpecificWord(String locator, String word, int howManyMatchesToCheck) {
        ...
        List<String> all_title_elements_text = new ArrayList<String>();

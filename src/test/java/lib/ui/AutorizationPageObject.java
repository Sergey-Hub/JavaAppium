...
public class AutorizationPageObject extends MainPageObject {
    private static final String
            LOGIN_BUTTON = "xpath://body/dif/a[text()='Log in']",
    ...
    public void enterLoginData(String login, String password){
        this.waitForElementAndSendKeys(LOGIN_INPUT, login,"Cannot find and find and put a login to the login input", 5);
        this.waitForElementAndSendKeys(PASSWORD_INPUT, login,"Cannot find and find and put a pass to the pass input", 5);
    }
